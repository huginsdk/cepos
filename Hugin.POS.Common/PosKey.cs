...
namespace Hugin.POS
{
    ...
    { 
        ...
        Check = ConsoleKey.Divide,
        ForeignCurrency = ConsoleKey.Multiply,
        Cash = ConsoleKey.Subtract,
        SubTotal = ConsoleKey.Add,
        Enter = ConsoleKey.Enter,
        Help = ConsoleKey.F1,
        Repeat = ConsoleKey.F2,
        Void = ConsoleKey.F3,
        CashDrawer = ConsoleKey.F4,
        Quantity = ConsoleKey.F5,
        Price = ConsoleKey.F6,
        Total = ConsoleKey.F7,
        PriceLookup = ConsoleKey.F8,
        PercentDiscount = ConsoleKey.F9,
        Discount = ConsoleKey.F10,
        PercentFee = ConsoleKey.F11,
        Fee = ConsoleKey.F12,
        ReceiveOnAcct = ConsoleKey.A,
        PayOut = ConsoleKey.V,
        Document = ConsoleKey.D,
        Customer = ConsoleKey.B,
        Report = ConsoleKey.R,
        Program = ConsoleKey.P,
        Command = ConsoleKey.O,
        Credit = ConsoleKey.C,
        SalesPerson = ConsoleKey.S,
        LabelStx = ConsoleKey.L,
        KeyStx = ConsoleKey.End, //Used for physical keylock
        MagstripeStx = ConsoleKey.Oem1,
        Payment = ConsoleKey.Home,
        Correction = ConsoleKey.Backspace,
        SendOrder = ConsoleKey.Q,
