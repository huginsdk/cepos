...
namespace Hugin.POS
{
    public class Number : IComparable, IFormattable
    {
        ...
        static CultureInfo cultureInfo = PosConfiguration.CultureInfo;
        static NumberFormatInfo nfi = cultureInfo.NumberFormat;
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            else
            {
                ...
                if (!Str.Contains(s,decimalSeperator)) return s;
                else
                {
                    char seperator = decimalSeperator.ToCharArray()[0];
                    String[] str = s.Split(seperator);
