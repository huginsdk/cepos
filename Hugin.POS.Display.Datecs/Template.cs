...
namespace Hugin.POS.Display.Datecs
{
    class Template
    {
        ...
        private static XmlDocument TemplateFile
        {
            get
            {
                if (templateFile == null)
                {
                    ...
                    String template = (String)Properties.Resources.ResourceManager.GetObject("Template");
        ...
        public static Font GetFont(XPath xpath)
        {
            ...
            if (xpath == XPath.CURRENT_CUST1 || xpath == XPath.CURRENT_CUST2)
            {
                return new Font(Display.PFC.Families[0], float.Parse(fnt[1]), (FontStyle)(int.Parse(fnt[2])), (GraphicsUnit)(int.Parse(fnt[3])),
