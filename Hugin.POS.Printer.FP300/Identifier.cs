...
namespace Hugin.POS.Printer
{
    ...
    public class Identifier
    {
        ...
        internal static byte[] CreateKeyChange(DeviceInfo devInfo)
        {
            ...
            keyChangePacket.AddRange(MessageBuilder.AddLength(devInfo.DevBrand.Length));
            keyChangePacket.AddRange(Encoding.ASCII.GetBytes(devInfo.DevBrand));

            //MODEL
            keyChangePacket.AddRange(MessageBuilder.HexToByteArray(GMPDataTags.DT_MODEL));
            keyChangePacket.AddRange(MessageBuilder.AddLength(devInfo.DevModel.Length));
            keyChangePacket.AddRange(Encoding.ASCII.GetBytes(devInfo.DevModel));
